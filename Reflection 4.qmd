...
date: today
date-format: long
abstract: "This document outlines the steps for accessing the 2022 ACS data, offers a concise overview of the ratio estimators method, presents the estimated figures alongside the actual respondent numbers, and provides our interpretation of the discrepancies between these values."
format: pdf
...
```
# Introduction
This paper is written with the help of R [@citeR]. All the data are gathered from IPUMS USA [@ipumsusa]. The code sections are done with the help of tidyverse [@tidyverse], labelled [@labelled] and knitr [@knitr].
